...
export default function PortfolioCard({ item }: { item: PortfolioItem }) {
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 flex translate-y-2 flex-col gap-1 p-4 opacity-0 transition duration-300 group-hover:translate-y-0 group-hover:opacity-100 md:p-5">
